...
// 주소로 좌표를 검색합니다
geocoder.addressSearch('서울 강남구 강남대로 352', function(result, status) {
...
function getWeatherData(lat, lng){
    fetch('https://api.openweathermap.org/data/2.5/weather?lat=' + lat + '&lon=' + lng + '&appid=db7cf435f5be897184da888c554879a7')
